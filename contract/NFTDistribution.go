...
// GetSalePrice is a free data retrieval call binding the contract method 0x338f3c8f.
//
// Solidity: function getSalePrice(address buyer, address inviter, address currentRateRule) view returns(uint256)
func (_NFTDistribution *NFTDistributionCaller) GetSalePrice(opts *bind.CallOpts, buyer common.Address, inviter common.Address, currentRateRule common.Address) (*big.Int, error) {
	var out []interface{}
	err := _NFTDistribution.contract.Call(opts, &out, "getSalePrice", buyer, inviter, currentRateRule)
...
//
// Solidity: function getSalePrice(address buyer, address inviter, address currentRateRule) view returns(uint256)
func (_NFTDistribution *NFTDistributionSession) GetSalePrice(buyer common.Address, inviter common.Address, currentRateRule common.Address) (*big.Int, error) {
	return _NFTDistribution.Contract.GetSalePrice(&_NFTDistribution.CallOpts, buyer, inviter, currentRateRule)
}

// GetSalePrice is a free data retrieval call binding the contract method 0x338f3c8f.
//
// Solidity: function getSalePrice(address buyer, address inviter, address currentRateRule) view returns(uint256)
func (_NFTDistribution *NFTDistributionCallerSession) GetSalePrice(buyer common.Address, inviter common.Address, currentRateRule common.Address) (*big.Int, error) {
	return _NFTDistribution.Contract.GetSalePrice(&_NFTDistribution.CallOpts, buyer, inviter, currentRateRule)
}

// GetTopCommissions is a free data retrieval call binding the contract method 0x60044bce.
//
// Solidity: function getTopCommissions() view returns((address,uint128,uint128,uint256)[])
...
// Sort is a free data retrieval call binding the contract method 0x4d6524db.
//
// Solidity: function sort((address,uint128,uint128,uint256)[] _input) pure returns((address,uint128,uint128,uint256)[])
...
//
// Solidity: function topCommissions(uint256 ) view returns(address user, uint128 buyCount, uint128 invitesCount, uint256 commission)
...
//
// Solidity: function userInfo(address ) view returns(address user, uint128 buyCount, uint128 invitesCount, uint256 commission)
...
//
// Solidity: function claimWithInviter(address inviter) returns()
...
//
// Solidity: function claimWithProof(address inviter, bytes32 proofRoot, bytes32[] proofPath) returns()
